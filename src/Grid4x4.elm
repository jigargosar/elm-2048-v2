module Grid4x4 exposing (Entry, Grid, Pos, allPositions, empty, emptyPositions, insertEntry, mapRows, mapRowsAsReversedLists, posAsInt2, reversedRowFromList, rowFromList, rowReverse, rowToList, toEntries)
